...
CREATE TABLE `5kcrm_admin_action_log` (
  ...
  PRIMARY KEY (`log_id`)
) ENGINE=InnoDB AUTO_INCREMENT=181 DEFAULT CHARSET=utf8 COMMENT='操作记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-08-16 23:50:08
