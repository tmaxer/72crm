...
INSERT INTO `5kcrm_admin_access` VALUES (1,1),(2,1),(3,3),(4,1),(5,1),(6,8),(7,8),(8,8),(9,8),(10,8),(11,8),(12,8),(13,8),(14,8),(16,8),(17,8),(18,8),(19,8),(20,8),(21,8),(15,10),(22,8),(23,8),(24,8),(25,8),(26,8),(27,8),(28,8),(29,8),(30,8);
...
CREATE TABLE `5kcrm_admin_action_log` (
  ...
  PRIMARY KEY (`log_id`)
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=utf8 COMMENT='操作记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=102 DEFAULT CHARSET=utf8 COMMENT='自定义字段表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `5kcrm_admin_field` VALUES (1,'',0,'create_user_id','创建人','user','',0,0,0,'','',99,3,1553788800,1553788800,0,NULL),(2,'',0,'update_time','更新时间','datetime','',0,0,0,'','',100,3,1553788800,1553788800,0,NULL),(3,'',0,'create_time','创建时间','datetime','',0,0,0,'','',101,3,1553788800,1553788800,0,NULL),(4,'',0,'owner_user_id','负责人','user','',0,0,0,'','',102,3,1553788800,1553788800,0,NULL),(5,'crm_leads',0,'name','线索名称','text','',0,1,1,'','',0,1,1553788800,1553788800,0,NULL),(6,'crm_leads',0,'source','线索来源','select','',0,0,0,'','促销活动\n搜索引擎\n广告\n转介绍\n线上注册\n线上询价\n预约上门\n陌拜\n招商资源\n公司资源\n展会资源\n个人资源\n电话咨询\n邮件咨询',0,1,1553788800,1553788800,0,NULL),(7,'crm_leads',0,'telephone','电话','text','',0,0,0,'','',0,1,1553788800,1553788800,0,NULL),(8,'crm_leads',0,'mobile','手机','mobile','',0,1,0,'','',0,1,1553788800,1553788800,0,NULL),(9,'crm_leads',0,'industry','客户行业','select','',0,0,0,'','IT/通信/电子/互联网\n金融业\n房地产\n商业服务\n贸易\n生产\n运输/物流\n服务业\n文化传媒\n政府\n其他',0,1,1553788800,1553788800,0,NULL),(10,'crm_leads',0,'level','客户级别','select','',0,0,0,'','A（重点客户）\nB（普通客户）\nC（非优先客户）',0,1,1553788800,1553788800,0,NULL),(11,'crm_leads',0,'detail_address','地址','text','',0,0,0,'','',0,1,1553788800,1553788800,0,NULL),(12,'crm_leads',0,'next_time','下次联系时间','datetime','',0,0,0,'','',0,1,1553788800,1553788800,0,NULL),(13,'crm_leads',0,'remark','备注','textarea','',0,0,0,'','',0,1,1553788800,1553788800,0,NULL),(14,'crm_customer',0,'name','客户名称','text','',0,1,1,'','',1,1,1553788800,1565850857,0,''),(15,'crm_customer',0,'level','客户级别','select','',0,0,0,'','A（重点客户）\nB（普通客户）\nC（非优先客户）',2,1,1553788800,1565850857,0,''),(16,'crm_customer',0,'industry','客户行业','select','其他',0,0,0,'','生产\n研发\n培训\n选4',3,1,1553788800,1565850857,0,''),(17,'crm_customer',0,'source','客户来源','select','',0,0,0,'','搜索引擎\n广告\n转介绍\n线上注册\n线上询价\n预约上门\n陌拜\n公司资源\n展会资源\n个人资源\n电话咨询\n邮件咨询',5,1,1553788800,1565850858,0,''),(18,'crm_customer',0,'deal_status','成交状态','select','未成交',0,0,1,'','未成交\n已成交',6,3,1553788800,1565850858,0,''),(19,'crm_customer',0,'telephone','电话','text','',0,0,0,'','',7,1,1553788800,1565850858,0,''),(20,'crm_customer',0,'website','网址','text','',0,0,0,'','',8,1,1553788800,1565850858,0,''),(21,'crm_customer',0,'next_time','下次联系时间','datetime','',0,0,0,'','',9,1,1553788800,1565850858,0,''),(22,'crm_customer',0,'remark','备注','textarea','',0,0,0,'','',10,1,1553788800,1565850858,0,''),(23,'crm_contacts',0,'name','姓名','text','',0,0,1,'','',0,1,1553788800,1553788800,0,NULL),(24,'crm_contacts',0,'customer_id','客户名称','customer','',0,0,1,'','',0,3,1553788800,1553788800,0,NULL),(25,'crm_contacts',0,'mobile','手机','mobile','',0,0,0,'','',0,1,1553788800,1553788800,0,NULL),(26,'crm_contacts',0,'telephone','电话','text','',0,0,0,'','',0,1,1553788800,1553788800,0,NULL),(27,'crm_contacts',0,'email','电子邮箱','email','',0,0,0,'','',0,1,1553788800,1553788800,0,NULL),(28,'crm_contacts',0,'decision','是否关键决策人','select','',0,0,0,'','是\n否',0,1,1553788800,1553788800,0,NULL),(29,'crm_contacts',0,'post','职务','text','',0,0,0,'','',0,1,1553788800,1553788800,0,NULL),(30,'crm_contacts',0,'sex','性别','select','',0,0,0,'','男\n女',0,1,1553788800,1553788800,0,NULL),(31,'crm_contacts',0,'detail_address','地址','text','',0,0,0,'','',0,1,1553788800,1553788800,0,NULL),(32,'crm_contacts',0,'next_time','下次联系时间','datetime','',0,0,0,'','',0,1,1553788800,1553788800,0,NULL),(33,'crm_contacts',0,'remark','备注','textarea','',0,0,0,'','',0,1,1553788800,1553788800,0,NULL),(34,'crm_business',0,'name','商机名称','text','',0,0,1,'','',0,1,1553788800,1553788800,0,NULL),(35,'crm_business',0,'customer_id','客户名称','customer','',0,0,1,'','',0,3,1553788800,1553788800,0,NULL),(36,'crm_business',0,'type_id','商机状态组','business_type','',0,0,1,'','',0,3,1553788800,1553788800,0,NULL),(37,'crm_business',0,'status_id','商机阶段','business_status','',0,0,1,'','',0,3,1553788800,1553788800,0,NULL),(38,'crm_business',0,'money','商机金额','floatnumber','',0,0,0,'元','',0,3,1553788800,1553788800,0,NULL),(39,'crm_business',0,'deal_date','预计成交日期','date','',0,0,1,'','',0,3,1553788800,1553788800,0,NULL),(40,'crm_business',0,'remark','备注','textarea','',0,0,0,'','',0,1,1553788800,1553788800,0,NULL),(41,'crm_contract',0,'num','合同编号','text','',0,1,1,'','',0,1,1553788800,1553788800,0,NULL),(42,'crm_contract',0,'name','合同名称','text','',0,0,1,'','',0,1,1553788800,1553788800,0,NULL),(43,'crm_contract',0,'customer_id','客户名称','customer','',0,0,1,'','',0,3,1553788800,1553788800,0,NULL),(44,'crm_contract',0,'business_id','商机名称','business','',0,0,0,'','',0,3,1553788800,1553788800,0,NULL),(45,'crm_contract',0,'order_date','下单时间','date','',0,0,0,'','',0,1,1553788800,1553788800,0,NULL),(46,'crm_contract',0,'money','合同金额','floatnumber','',0,0,1,'元','',0,1,1553788800,1553788800,0,NULL),(47,'crm_contract',0,'start_time','合同开始时间','date','',0,0,0,'','',0,3,1553788800,1553788800,0,NULL),(48,'crm_contract',0,'end_time','合同到期时间','date','',0,0,0,'','',0,3,1553788800,1553788800,0,NULL),(49,'crm_contract',0,'contacts_id','客户签约人','contacts','',0,0,0,'','',0,3,1553788800,1553788800,0,NULL),(50,'crm_contract',0,'order_user_id','公司签约人','user','',0,0,0,'','',0,3,1553788800,1553788800,0,NULL),(51,'crm_contract',0,'remark','备注','textarea','',0,0,0,'','',0,1,1553788800,1553788800,0,NULL),(52,'crm_receivables',0,'number','回款编号','text','',0,1,1,'','',0,3,1553788800,1553788800,0,NULL),(53,'crm_receivables',0,'customer_id','客户名称','customer','',0,0,1,'','',0,3,1553788800,1553788800,0,NULL),(54,'crm_receivables',0,'contract_id','合同编号','contract','',0,0,1,'','',0,3,1553788800,1553788800,0,NULL),(55,'crm_receivables',0,'return_time','回款日期','date','',0,0,1,'','',0,3,1553788800,1553788800,0,NULL),(56,'crm_receivables',0,'return_type','回款方式','select','',0,0,1,'','支票\n现金\n邮政汇款\n电汇\n网上转账\n支付宝\n微信支付\n其他',0,3,1553788800,1553788800,0,NULL),(57,'crm_receivables',0,'money','回款金额','floatnumber','',0,0,1,'元','',0,3,1553788800,1553788800,0,NULL),(58,'crm_receivables',0,'plan_id','期数','receivables_plan','',0,0,0,'','',0,3,1553788800,1553788800,0,NULL),(59,'crm_receivables',0,'remark','备注','textarea','',0,0,0,'','',0,1,1553788800,1553788800,0,NULL),(60,'crm_product',0,'name','产品名称','text','',0,0,1,'','',0,1,1553788800,1553788800,0,NULL),(61,'crm_product',0,'category_id','产品类别','category','',0,0,1,'','',0,3,1553788800,1553788800,0,NULL),(62,'crm_product',0,'num','产品编码','text','',0,0,1,'','',0,3,1553788800,1553788800,0,NULL),(63,'crm_product',0,'status','是否上架','select','上架',0,0,1,'','上架\n下架',0,3,1553788800,1553788800,0,NULL),(64,'crm_product',0,'unit','单位','select','',0,0,1,'','个\n块\n只\n把\n枚\n瓶\n盒\n台\n吨\n千克\n米\n箱',0,1,1553788800,1553788800,0,NULL),(65,'crm_product',0,'price','标准价格','floatnumber','',0,0,1,'元','',0,1,1553788800,1553788800,0,NULL),(66,'crm_product',0,'description','产品描述','text','',0,0,0,'','',0,1,1553788800,1553788800,0,NULL),(67,'oa_examine',1,'content','审批内容','text','',0,0,1,'','',0,3,1553788800,1553788800,0,NULL),(68,'oa_examine',1,'remark','备注','textarea','',0,0,0,'','',0,3,1553788800,1553788800,0,NULL),(69,'oa_examine',2,'type_id','请假类型','select','',0,0,1,'','年假\n事假\n病假\n产假\n调休\n婚假\n丧假\n其他',0,3,1553788800,1553788800,0,NULL),(70,'oa_examine',2,'content','审批内容','text','',0,0,1,'','',0,3,1553788800,1553788800,0,NULL),(71,'oa_examine',2,'start_time','开始时间','datetime','',0,0,1,'','',0,3,1553788800,1553788800,0,NULL),(72,'oa_examine',2,'end_time','结束时间','datetime','',0,0,1,'','',0,3,1553788800,1553788800,0,NULL),(73,'oa_examine',2,'duration','时长(天)','floatnumber','',0,0,1,'','',0,3,1553788800,1553788800,0,NULL),(74,'oa_examine',2,'remark','备注','textarea','',0,0,0,'','',0,3,1553788800,1553788800,0,NULL),(75,'oa_examine',3,'content','出差事由','text','',0,0,1,'','',0,3,1553788800,1553788800,0,NULL),(76,'oa_examine',3,'remark','备注','textarea','',0,0,0,'','',0,3,1553788800,1553788800,0,NULL),(77,'oa_examine',3,'cause','行程明细','business_cause','',0,0,1,'','',0,3,1553788800,1553788800,0,NULL),(78,'oa_examine',3,'duration','出差总天数','floatnumber','',0,0,1,'','',0,3,1553788800,1553788800,0,NULL),(79,'oa_examine',4,'content','加班原因','text','',0,0,1,'','',0,3,1553788800,1553788800,0,NULL),(80,'oa_examine',4,'start_time','开始时间','datetime','',0,0,1,'','',0,3,1553788800,1553788800,0,NULL),(81,'oa_examine',4,'end_time','结束时间','datetime','',0,0,1,'','',0,3,1553788800,1553788800,0,NULL),(82,'oa_examine',4,'duration','加班总天数','floatnumber','',0,0,1,'','',0,3,1553788800,1553788800,0,NULL),(83,'oa_examine',4,'remark','备注','textarea','',0,0,0,'','',0,3,1553788800,1553788800,0,NULL),(84,'oa_examine',5,'content','差旅事由','text','',0,0,1,'','',0,3,1553788800,1553788800,0,NULL),(85,'oa_examine',5,'cause','费用明细','examine_cause','',0,0,1,'','',0,3,1553788800,1553788800,0,NULL),(86,'oa_examine',5,'money','报销总金额','floatnumber','',0,0,1,'','',0,3,1553788800,1553788800,0,NULL),(87,'oa_examine',5,'remark','备注','textarea','',0,0,0,'','',0,3,1553788800,1553788800,0,NULL),(88,'oa_examine',6,'content','借款事由','text','',0,0,1,'','',0,3,1553788800,1553788800,0,NULL),(89,'oa_examine',6,'money','借款金额（元）','floatnumber','',0,0,1,'','',0,3,1553788800,1553788800,0,NULL),(90,'oa_examine',6,'remark','备注','textarea','',0,0,0,'','',0,3,1553788800,1553788800,0,NULL),(91,'crm_receivables_plan',0,'customer_id','客户名称','customer','',0,0,1,'','',0,3,1553788800,1553788800,0,NULL),(92,'crm_receivables_plan',0,'contract_id','合同编号','contract','',0,0,1,'','',0,3,1553788800,1553788800,0,NULL),(93,'crm_receivables_plan',0,'money','计划回款金额','floatnumber','',0,0,1,'','',0,3,1553788800,1553788800,0,NULL),(94,'crm_receivables_plan',0,'return_date','计划回款日期','date','',0,0,1,'','',0,3,1553788800,1553788800,0,NULL),(95,'crm_receivables_plan',0,'return_type','计划回款方式','select','',0,0,1,'','支票\n现金\n邮政汇款\n电汇\n网上转账\n支付宝\n微信支付\n其他\n在线支付\n线下支付\n预存款\n返利\n预存款+返利',0,3,1553788800,1553788800,0,NULL),(96,'crm_receivables_plan',0,'remind','提前几日提醒','number','',0,0,0,'','',0,3,1553788800,1553788800,0,NULL),(97,'crm_receivables_plan',0,'remark','备注','textarea','',0,0,0,'','',0,1,1553788800,1553788800,0,NULL),(98,'crm_receivables_plan',0,'file','附件','file','',0,0,0,'','',0,1,1553788800,1553788800,0,NULL),(99,'crm_customer',0,'mobile','手机','mobile','',0,1,0,'','',12,1,1553788800,1565850859,0,''),(100,'crm_customer',0,'crm_dkqyzy','所属部门','select','选3',0,1,1,'','产品事业部\n培训部\n食品部',4,0,1565850023,1565850858,0,''),(101,'crm_customer',0,'crm_broxyl','人员','user','',0,0,0,'',NULL,11,0,1565850024,1565850858,0,'');
...
INSERT INTO `5kcrm_crm_business_status` VALUES (1,0,'赢单','100',99),(2,0,'输单','0',100),(3,0,'无效','0',101),(4,1,'验证客户','20',1),(5,1,'需求分析','15',2),(6,1,'方案/报价','30',3),(7,1,'谈判审核','30',4);
...
INSERT INTO `5kcrm_crm_config` VALUES (1,'follow_day','15','距跟进天数'),(2,'deal_day','30','距成交天数'),(3,'config','1','1启用规则'),(4,'contract_day','30','合同到期提醒天数'),(5,'record_type','[\"\\u6253\\u7535\\u8bdd\",\"\\u53d1\\u90ae\\u4ef6\",\"\\u53d1\\u77ed\\u4fe1\",\"\\u89c1\\u9762\\u62dc\\u8bbf\",\"\\u6d3b\\u52a8\"]','跟进记录类型'),(6,'contract_config','1','1开启');
...
CREATE TABLE `5kcrm_crm_customer` (
  ...
  `create_time` int(11) NOT NULL COMMENT '创建时间',
  `update_time` int(11) NOT NULL COMMENT '更新时间',
  `crm_dkqyzy` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '选3' COMMENT '所属部门',
...
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='员工档案表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-08-15 16:20:57
